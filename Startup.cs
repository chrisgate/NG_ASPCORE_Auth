...
namespace Ng_Core_Auth
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //configure stronglyly type settings type
            ...
            {
                options.AddPolicy("RequiredLoggenIn", policy =>policy.RequireRole("Admin", "Customer", "Moderator").RequireAuthenticatedUser());
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            //app.UseCors(optiions =>
            //optiions.WithOrigins("localhost:56649")
            //.AllowAnyMethod()
            //.AllowAnyHeader()
            //.AllowCredentials());
